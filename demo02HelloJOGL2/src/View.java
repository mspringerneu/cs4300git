...
public class View {
    ...
    public void init(GLAutoDrawable gla) throws Exception {
        ...
        for (int i = 0; i < 360; i += (360/SLICES)) {
            positions.add(new Vector4f(RADIUS * (float)Math.cos(Math.toRadians(i)),RADIUS * (float)Math.sin(Math.toRadians(i)), 0, 1.0f));
        }
        /*
        ...
        */
        ...
        obj = new ObjectInstance(gl, program, shaderLocations, shaderToVertexAttribute, mesh, "line loop");
