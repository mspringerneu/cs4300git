...
public class ObjImporter {
  public static <K extends IVertexData> PolygonMesh<K> importFile(util.VertexProducer<K> producer, InputStream in, boolean scaleAndCenter) throws IllegalArgumentException {
