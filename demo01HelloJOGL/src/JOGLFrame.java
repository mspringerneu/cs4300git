...
public class JOGLFrame extends JFrame {
    ...
    public JOGLFrame(String title) {
        ...
        GLProfile glp = GLProfile.getGL2GL3();  // create openGL profile
        //GLProfile.getDefault();
        GLCapabilities caps = new GLCapabilities(glp);  // set of capabilities based on the profile
        GLCanvas canvas = new GLCanvas(caps);  // create a canvas based on the capabilities
