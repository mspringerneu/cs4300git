...
public class View {
    ...
    public void init(GLAutoDrawable gla) throws Exception {
        ...
        // Read indices 3 at a time and draw a triangle
        mesh.setPrimitiveType(GL.GL_TRIANGLES);
        // How many indices to read at a time
        ...
        // FloatBuffer - low-level float array
        color = FloatBuffer.wrap(new float[]{0, 1, 1, 0});
    ...
    public void draw(GLAutoDrawable gla) {
        ...
        //gl .glPolygonMode(GL.GL_FRONT_AND_BACK, GL3.GL_LINE); // show individual polygons
