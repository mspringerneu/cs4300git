...
public class View {
  ...
  private void initObjects(GL3 gl) throws FileNotFoundException, IOException {
    ...
    t = new Matrix4f().translate(-30, 0, 0).scale(50, 50, 50);
    transforms.add(t);
    ...
    mat.setAmbient(0.3f, 0.3f, 0.1f);
    mat.setDiffuse(0.7f, 0.7f, 0.1f);
    mat.setSpecular(0.7f, 0.7f, 0.1f);
    mat.setShininess(10);
    materials.add(mat);
  ...
  private void initLights() {
    ...
    lights.add(l);
    lightCoordinateSystems.add(meshObjects.size()+1); //view


    l = new util.Light();
    l.setAmbient(0.0f, 0.0f, 0.0f);
    l.setDiffuse(0.2f, 0.2f, 0.9f);
    l.setSpecular(0.2f, 0.2f, 0.9f);
    l.setPosition(00, 2, 0);
    lights.add(l);
    lightCoordinateSystems.add(0); //white sphere
  ...
  public void draw(GLAutoDrawable gla) {
    ...
    modelView = new Matrix4f().lookAt(
            new Vector3f((float)(80*Math.cos(0.02f*angleOfRotation)),
                    0.0f, (float)(80*Math.sin(0.02f*angleOfRotation))),
            new Vector3f(0, 0, 0),
            new Vector3f(0, 1, 0));
