...
public class ObjectInstance {
  ...
  public ObjectInstance(GL2GL3 gl, String name) {
  ...
  public <K extends IVertexData> ObjectInstance(GL2GL3 gl, ShaderProgram program, util.ShaderLocationsVault shaderLocations, Map<String, String> shaderVarsToAttributeNames, PolygonMesh<K> mesh, String name) {
   ...
   */
  protected <K extends IVertexData> void initPolygonMesh(GL2GL3 gl, ShaderProgram program, util.ShaderLocationsVault shaderLocations, Map<String, String> shaderVarsToAttributeNames, PolygonMesh<K> mesh) {
    int i, j;
