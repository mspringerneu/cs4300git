...
public class ShaderProgram {
   ...
   *                               be found
   */
  public void createProgram(GL2GL3 gl, String vertShaderFile, String fragShaderFile) throws FileNotFoundException, Exception {
    releaseShaders(gl);
   ...
   * again.
   */
  public void releaseShaders(GL2GL3 gl) {
  ...
  public ShaderLocationsVault getAllShaderVariables(GL2GL3 gl) {
  ...
  private int getUniformLocation(GL2GL3 gl, String name) {
  ...
  private int getAttributeLocation(GL2GL3 gl, String name) {
    boolean enabledStatus = enabled;
  ...
  private int createShaders(GL2GL3 gl) throws FileNotFoundException, Exception {
    Scanner file;
    int shaderProgram;
    IntBuffer linked;
